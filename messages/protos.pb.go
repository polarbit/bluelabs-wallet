...
var file_messages_protos_proto_rawDesc = []byte{
	...
	0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x70, 0x6f, 0x6c, 0x61, 0x72, 0x62, 0x69, 0x74, 0x2f,
	0x62, 0x6c, 0x75, 0x65, 0x6c, 0x61, 0x62, 0x73, 0x2d, 0x77, 0x61, 0x6c, 0x6c, 0x65, 0x74, 0x2f,
...
var file_messages_protos_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_messages_protos_proto_goTypes = []interface{}{
...
func file_messages_protos_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_messages_protos_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_messages_protos_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
